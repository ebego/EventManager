...
public class InitialDataRunner implements CommandLineRunner {
    ...
    public void seedData() {
        ...
        createIfNotPresent("Enrique Iglesias", "Enrique Iglesias comes in Tirana for the first time for Spanish Culture Week in Skanderbeg Square on 30th June. We can't wait for his concert here, along with the other famous artists that our city will be expecting this summer!", "2023-09-15", adminUser.getId(), 10000, "enrique.jpg",4,300,"Tirane");
        createIfNotPresent("Elvana Gjata", "Elvana Gjata recently announced that she will be hosting a concert at Air Albania stadium. She said that September 22 will be a very special night for her and she hopes it will be for everyone.", "2023-12-22", adminUser.getId(), 10000, "egjata.jpg",100,42,"Tirane");
